 ...
 *
 * @param {Module[]} a - the first array of modules
 * @param {Module[]} b - the second array of modules
 * @return {Module[]} the merged array of modules
 */
function mergeArrays(a: Module[], b: Module[]): Module[] {
    for (const ele of b) {
        const item = a.find((v) => {
...
function startScheduler() {
    ...
    scheduler.run(async () => {
        ...
        consola.success('Scheduler successfully')
    }).everyMinutes(1)
}
